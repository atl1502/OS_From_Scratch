...
int32_t sys_read (fd_t* fd, void* buf, int32_t nbytes); // syscall #3
int32_t sys_write (fd_t* fd, const void* buf, int32_t nbytes); // syscall #4
int32_t sys_open (const uint8_t* filename); // syscall #5
int32_t sys_close (fd_t* fd); // syscall #6
